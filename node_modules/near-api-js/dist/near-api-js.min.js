...
},{"../asn1":19,"inherits":155,"vm":255}],21:[function(require,module,exports){
...
},{"../base":22,"buffer":75,"inherits":155}],22:[function(require,module,exports){
...
},{"../base":22,"minimalistic-assert":165}],24:[function(require,module,exports){
...
},{"../../asn1":19,"inherits":155}],28:[function(require,module,exports){
...
},{"./der":27,"buffer":75,"inherits":155}],30:[function(require,module,exports){
...
},{"../../asn1":19,"buffer":75,"inherits":155}],31:[function(require,module,exports){
...
},{"safe-buffer":227}],34:[function(require,module,exports){
...
},{"./buffer.js":37,"./types.js":41}],39:[function(require,module,exports){
...
},{"./deserialize.js":38,"./serialize.js":40,"./utils.js":42}],40:[function(require,module,exports){
...
},{"./buffer.js":37,"./types.js":41,"./utils.js":42}],41:[function(require,module,exports){
...
},{"./types.js":41}],43:[function(require,module,exports){
...
},{"safe-buffer":227}],46:[function(require,module,exports){
...
},{"./aes":45,"./ghash":50,"./incr32":51,"buffer-xor":74,"cipher-base":79,"inherits":155,"safe-buffer":227}],47:[function(require,module,exports){
...
},{"./aes":45,"./authCipher":46,"./modes":58,"./streamCipher":61,"cipher-base":79,"evp_bytestokey":125,"inherits":155,"safe-buffer":227}],49:[function(require,module,exports){
...
},{"./aes":45,"./authCipher":46,"./modes":58,"./streamCipher":61,"cipher-base":79,"evp_bytestokey":125,"inherits":155,"safe-buffer":227}],50:[function(require,module,exports){
...
},{"safe-buffer":227}],51:[function(require,module,exports){
...
},{"buffer-xor":74}],53:[function(require,module,exports){
...
},{"buffer-xor":74,"safe-buffer":227}],54:[function(require,module,exports){
...
},{"safe-buffer":227}],55:[function(require,module,exports){
...
},{"safe-buffer":227}],56:[function(require,module,exports){
...
},{"../incr32":51,"buffer-xor":74,"safe-buffer":227}],57:[function(require,module,exports){
...
},{"buffer":75,"buffer-xor":74}],61:[function(require,module,exports){
...
},{"./aes":45,"cipher-base":79,"inherits":155,"safe-buffer":227}],62:[function(require,module,exports){
...
},{"browserify-aes/browser":47,"browserify-aes/modes":58,"browserify-des":63,"browserify-des/modes":64,"evp_bytestokey":125}],63:[function(require,module,exports){
...
},{"cipher-base":79,"des.js":90,"inherits":155,"safe-buffer":227}],64:[function(require,module,exports){
...
},{"bn.js":36,"buffer":75,"randombytes":195}],66:[function(require,module,exports){
...
"use strict";var Buffer=require("safe-buffer").Buffer,createHash=require("create-hash"),stream=require("readable-stream"),inherits=require("inherits"),sign=require("./sign"),verify=require("./verify"),algorithms=require("./algorithms.json");function Sign(e){stream.Writable.call(this);var t=algorithms[e];if(!t)throw new Error("Unknown message digest");this._hashType=t.hash,this._hash=createHash(t.hash),this._tag=t.id,this._signType=t.sign}function Verify(e){stream.Writable.call(this);var t=algorithms[e];if(!t)throw new Error("Unknown message digest");this._hash=createHash(t.hash),this._tag=t.id,this._signType=t.sign}function createSign(e){return new Sign(e)}function createVerify(e){return new Verify(e)}Object.keys(algorithms).forEach(function(e){algorithms[e].id=Buffer.from(algorithms[e].id,"hex"),algorithms[e.toLowerCase()]=algorithms[e]}),inherits(Sign,stream.Writable),Sign.prototype._write=function(e,t,r){this._hash.update(e),r()},Sign.prototype.update=function(e,t){return this._hash.update("string"==typeof e?Buffer.from(e,t):e),this},Sign.prototype.sign=function(e,t){this.end();var r=this._hash.digest(),i=sign(r,e,this._hashType,this._signType,this._tag);return t?i.toString(t):i},inherits(Verify,stream.Writable),Verify.prototype._write=function(e,t,r){this._hash.update(e),r()},Verify.prototype.update=function(e,t){return this._hash.update("string"==typeof e?Buffer.from(e,t):e),this},Verify.prototype.verify=function(e,t,r){var i="string"==typeof t?Buffer.from(t,r):t;this.end();var s=this._hash.digest();return verify(i,s,e,this._signType,this._tag)},module.exports={Sign:createSign,Verify:createVerify,createSign:createSign,createVerify:createVerify};

},{"./algorithms.json":67,"./sign":70,"./verify":71,"create-hash":82,"inherits":155,"readable-stream":207,"safe-buffer":227}],70:[function(require,module,exports){
"use strict";var Buffer=require("safe-buffer").Buffer,createHmac=require("create-hmac"),crt=require("browserify-rsa"),EC=require("elliptic").ec,BN=require("bn.js"),parseKeys=require("parse-asn1"),curves=require("./curves.json"),RSA_PKCS1_PADDING=1;function sign(e,r,t,a,n){var u=parseKeys(r);if(u.curve){if("ecdsa"!==a&&"ecdsa/rsa"!==a)throw new Error("wrong private key type");return ecSign(e,u)}if("dsa"===u.type){if("dsa"!==a)throw new Error("wrong private key type");return dsaSign(e,u,t)}if("rsa"!==a&&"ecdsa/rsa"!==a)throw new Error("wrong private key type");if(void 0!==r.padding&&r.padding!==RSA_PKCS1_PADDING)throw new Error("illegal or unsupported padding mode");e=Buffer.concat([n,e]);for(var o=u.modulus.byteLength(),i=[0,1];e.length+i.length+1<o;)i.push(255);i.push(0);for(var f=-1;++f<e.length;)i.push(e[f]);return crt(i,u)}function ecSign(e,r){var t=curves[r.curve.join(".")];if(!t)throw new Error("unknown curve "+r.curve.join("."));var a=new EC(t).keyFromPrivate(r.privateKey).sign(e);return Buffer.from(a.toDER())}function dsaSign(e,r,t){for(var a,n=r.params.priv_key,u=r.params.p,o=r.params.q,i=r.params.g,f=new BN(0),c=bits2int(e,o).mod(o),s=!1,d=getKey(n,o,e,t);!1===s;)f=makeR(i,a=makeKey(o,d,t),u,o),0===(s=a.invm(o).imul(c.add(n.mul(f))).mod(o)).cmpn(0)&&(s=!1,f=new BN(0));return toDER(f,s)}function toDER(e,r){e=e.toArray(),r=r.toArray(),128&e[0]&&(e=[0].concat(e)),128&r[0]&&(r=[0].concat(r));var t=[48,e.length+r.length+4,2,e.length];return t=t.concat(e,[2,r.length],r),Buffer.from(t)}function getKey(e,r,t,a){if((e=Buffer.from(e.toArray())).length<r.byteLength()){var n=Buffer.alloc(r.byteLength()-e.length);e=Buffer.concat([n,e])}var u=t.length,o=bits2octets(t,r),i=Buffer.alloc(u);i.fill(1);var f=Buffer.alloc(u);return f=createHmac(a,f).update(i).update(Buffer.from([0])).update(e).update(o).digest(),i=createHmac(a,f).update(i).digest(),{k:f=createHmac(a,f).update(i).update(Buffer.from([1])).update(e).update(o).digest(),v:i=createHmac(a,f).update(i).digest()}}function bits2int(e,r){var t=new BN(e),a=(e.length<<3)-r.bitLength();return a>0&&t.ishrn(a),t}function bits2octets(e,r){e=(e=bits2int(e,r)).mod(r);var t=Buffer.from(e.toArray());if(t.length<r.byteLength()){var a=Buffer.alloc(r.byteLength()-t.length);t=Buffer.concat([a,t])}return t}function makeKey(e,r,t){var a,n;do{for(a=Buffer.alloc(0);8*a.length<e.bitLength();)r.v=createHmac(t,r.k).update(r.v).digest(),a=Buffer.concat([a,r.v]);n=bits2int(a,e),r.k=createHmac(t,r.k).update(r.v).update(Buffer.from([0])).digest(),r.v=createHmac(t,r.k).update(r.v).digest()}while(-1!==n.cmp(e));return n}function makeR(e,r,t,a){return e.toRed(BN.mont(t)).redPow(r).fromRed().mod(a)}module.exports=sign,module.exports.getKey=getKey,module.exports.makeKey=makeKey;

},{"./curves.json":68,"bn.js":36,"browserify-rsa":65,"create-hmac":84,"elliptic":100,"parse-asn1":174,"safe-buffer":227}],71:[function(require,module,exports){
"use strict";var Buffer=require("safe-buffer").Buffer,BN=require("bn.js"),EC=require("elliptic").ec,parseKeys=require("parse-asn1"),curves=require("./curves.json");function verify(e,r,t,a,n){var o=parseKeys(t);if("ec"===o.type){if("ecdsa"!==a&&"ecdsa/rsa"!==a)throw new Error("wrong public key type");return ecVerify(e,r,o)}if("dsa"===o.type){if("dsa"!==a)throw new Error("wrong public key type");return dsaVerify(e,r,o)}if("rsa"!==a&&"ecdsa/rsa"!==a)throw new Error("wrong public key type");r=Buffer.concat([n,r]);for(var u=o.modulus.byteLength(),i=[1],f=0;r.length+i.length+2<u;)i.push(255),f+=1;i.push(0);for(var s=-1;++s<r.length;)i.push(r[s]);i=Buffer.from(i);var c=BN.mont(o.modulus);e=(e=new BN(e).toRed(c)).redPow(new BN(o.publicExponent)),e=Buffer.from(e.fromRed().toArray());var d=f<8?1:0;for(u=Math.min(e.length,i.length),e.length!==i.length&&(d=1),s=-1;++s<u;)d|=e[s]^i[s];return 0===d}function ecVerify(e,r,t){var a=curves[t.data.algorithm.curve.join(".")];if(!a)throw new Error("unknown curve "+t.data.algorithm.curve.join("."));var n=new EC(a),o=t.data.subjectPrivateKey.data;return n.verify(r,e,o)}function dsaVerify(e,r,t){var a=t.data.p,n=t.data.q,o=t.data.g,u=t.data.pub_key,i=parseKeys.signature.decode(e,"der"),f=i.s,s=i.r;checkValue(f,n),checkValue(s,n);var c=BN.mont(a),d=f.invm(n);return 0===o.toRed(c).redPow(new BN(r).mul(d).mod(n)).fromRed().mul(u.toRed(c).redPow(s.mul(d).mod(n)).fromRed()).mod(a).mod(n).cmp(s)}function checkValue(e,r){if(e.cmpn(0)<=0)throw new Error("invalid sig");if(e.cmp(r)>=0)throw new Error("invalid sig")}module.exports=verify;

},{"./curves.json":68,"bn.js":36,"elliptic":100,"parse-asn1":174,"safe-buffer":227}],72:[function(require,module,exports){
...
},{"base-x":33}],74:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"base64-js":34,"buffer":75,"ieee754":153}],76:[function(require,module,exports){
...
},{"./":78,"get-intrinsic":130}],78:[function(require,module,exports){
...
},{"es-define-property":116,"es-errors/type":122,"function-bind":127,"get-intrinsic":130,"set-function-length":228}],79:[function(require,module,exports){
...
},{"inherits":155,"safe-buffer":227,"stream":241,"string_decoder":247}],80:[function(require,module,exports){
...
},{"bn.js":35,"buffer":75,"elliptic":100}],82:[function(require,module,exports){
...
},{"cipher-base":79,"inherits":155,"md5.js":163,"ripemd160":225,"sha.js":231}],83:[function(require,module,exports){
var MD5=require("md5.js");module.exports=function(e){return(new MD5).update(e).digest()};

},{"md5.js":163}],84:[function(require,module,exports){
...
},{"./legacy":85,"cipher-base":79,"create-hash/md5":83,"inherits":155,"ripemd160":225,"safe-buffer":227,"sha.js":231}],85:[function(require,module,exports){
...
},{"cipher-base":79,"inherits":155,"safe-buffer":227}],86:[function(require,module,exports){
...
},{"browserify-cipher":62,"browserify-sign":69,"browserify-sign/algos":66,"create-ecdh":81,"create-hash":82,"create-hmac":84,"diffie-hellman":96,"pbkdf2":175,"public-encrypt":183,"randombytes":195,"randomfill":196}],87:[function(require,module,exports){
...
},{"es-define-property":116,"es-errors/syntax":121,"es-errors/type":122,"gopd":131}],88:[function(require,module,exports){
...
},{"inherits":155,"minimalistic-assert":165}],92:[function(require,module,exports){
...
},{"minimalistic-assert":165}],93:[function(require,module,exports){
...
},{"./cipher":92,"./utils":95,"inherits":155,"minimalistic-assert":165}],94:[function(require,module,exports){
...
},{"./cipher":92,"./des":93,"inherits":155,"minimalistic-assert":165}],95:[function(require,module,exports){
...
},{"./lib/dh":97,"./lib/generatePrime":98,"./lib/primes.json":99,"buffer":75}],97:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"./generatePrime":98,"bn.js":35,"buffer":75,"miller-rabin":164,"randombytes":195}],98:[function(require,module,exports){
...
},{"bn.js":35,"miller-rabin":164,"randombytes":195}],99:[function(require,module,exports){
module.exports={
    "modp1": {
        "gen": "02",
...
},{"../package.json":115,"./elliptic/curve":103,"./elliptic/curves":106,"./elliptic/ec":107,"./elliptic/eddsa":110,"./elliptic/utils":114,"brorand":43}],101:[function(require,module,exports){
...
},{"../utils":114,"bn.js":35}],102:[function(require,module,exports){
...
},{"../utils":114,"./base":101,"bn.js":35,"inherits":155}],103:[function(require,module,exports){
...
},{"../utils":114,"./base":101,"bn.js":35,"inherits":155}],105:[function(require,module,exports){
...
},{"../utils":114,"./base":101,"bn.js":35,"inherits":155}],106:[function(require,module,exports){
...
},{"./curve":103,"./precomputed/secp256k1":113,"./utils":114,"hash.js":137}],107:[function(require,module,exports){
...
},{"../curves":106,"../utils":114,"./key":108,"./signature":109,"bn.js":35,"brorand":43,"hmac-drbg":150}],108:[function(require,module,exports){
...
},{"../utils":114,"bn.js":35}],109:[function(require,module,exports){
...
},{"../utils":114,"bn.js":35}],110:[function(require,module,exports){
...
},{"../curves":106,"../utils":114,"./key":111,"./signature":112,"hash.js":137}],111:[function(require,module,exports){
...
},{"../utils":114,"bn.js":35}],113:[function(require,module,exports){
...
"use strict";var utils=exports,BN=require("bn.js"),minAssert=require("minimalistic-assert"),minUtils=require("minimalistic-crypto-utils");function getNAF(t,r,i){var n,e=new Array(Math.max(t.bitLength(),i)+1);for(n=0;n<e.length;n+=1)e[n]=0;var s=1<<r+1,u=t.clone();for(n=0;n<e.length;n++){var l,o=u.andln(s-1);u.isOdd()?(l=o>(s>>1)-1?(s>>1)-o:o,u.isubn(l)):l=0,e[n]=l,u.iushrn(1)}return e}function getJSF(t,r){var i=[[],[]];t=t.clone(),r=r.clone();for(var n,e=0,s=0;t.cmpn(-e)>0||r.cmpn(-s)>0;){var u,l,o=t.andln(3)+e&3,a=r.andln(3)+s&3;3===o&&(o=-1),3===a&&(a=-1),u=0==(1&o)?0:3!==(n=t.andln(7)+e&7)&&5!==n||2!==a?o:-o,i[0].push(u),l=0==(1&a)?0:3!==(n=r.andln(7)+s&7)&&5!==n||2!==o?a:-a,i[1].push(l),2*e===u+1&&(e=1-e),2*s===l+1&&(s=1-s),t.iushrn(1),r.iushrn(1)}return i}function cachedProperty(t,r,i){var n="_"+r;t.prototype[r]=function(){return void 0!==this[n]?this[n]:this[n]=i.call(this)}}function parseBytes(t){return"string"==typeof t?utils.toArray(t,"hex"):t}function intFromLE(t){return new BN(t,"hex","le")}utils.assert=minAssert,utils.toArray=minUtils.toArray,utils.zero2=minUtils.zero2,utils.toHex=minUtils.toHex,utils.encode=minUtils.encode,utils.getNAF=getNAF,utils.getJSF=getJSF,utils.cachedProperty=cachedProperty,utils.parseBytes=parseBytes,utils.intFromLE=intFromLE;

},{"bn.js":35,"minimalistic-assert":165,"minimalistic-crypto-utils":166}],115:[function(require,module,exports){
module.exports={
  "name": "elliptic",
  "version": "6.5.5",
...
},{"get-intrinsic":130}],117:[function(require,module,exports){
...
},{"md5.js":163,"safe-buffer":227}],126:[function(require,module,exports){
...
for(var util=require("util"),isProperty=require("is-property"),INDENT_START=/[\{\[]/,INDENT_END=/[\}\]]/,RESERVED=["do","if","in","for","let","new","try","var","case","else","enum","eval","null","this","true","void","with","await","break","catch","class","const","false","super","throw","while","yield","delete","export","import","public","return","static","switch","typeof","default","extends","finally","package","private","continue","debugger","function","arguments","interface","protected","implements","instanceof","NaN","undefined"],RESERVED_MAP={},i=0;i<RESERVED.length;i++)RESERVED_MAP[RESERVED[i]]=!0;var isVariable=function(t){return isProperty(t)&&!RESERVED_MAP.hasOwnProperty(t)},formats={s:function(t){return""+t},d:function(t){return""+Number(t)},o:function(t){return JSON.stringify(t)}},genfun=function(){var t=[],n=0,e={},r=function(e){for(var r="";r.length<2*n;)r+="  ";t.push(r+e)},i=function(t){return INDENT_END.test(t.trim()[0])&&INDENT_START.test(t[t.length-1])?(n--,r(t),void n++):INDENT_START.test(t[t.length-1])?(r(t),void n++):INDENT_END.test(t.trim()[0])?(n--,void r(t)):void r(t)},o=function(t){if(!t)return o;if(1===arguments.length&&t.indexOf("\n")>-1)for(var n=t.trim().split("\n"),e=0;e<n.length;e++)i(n[e].trim());else i(util.format.apply(util,arguments));return o};return o.scope={},o.formats=formats,o.sym=function(t){return t&&isVariable(t)||(t="tmp"),e[t]||(e[t]=0),t+(e[t]++||"")},o.property=function(t,n){return 1===arguments.length&&(n=t,t=""),isProperty(n+="")?t?t+"."+n:n:t?t+"["+JSON.stringify(n)+"]":JSON.stringify(n)},o.toString=function(){return t.join("\n")},o.toFunction=function(t){t||(t={});var n="return ("+o.toString()+")";Object.keys(o.scope).forEach(function(n){t[n]||(t[n]=o.scope[n])});var e=Object.keys(t).map(function(t){return t}),r=e.map(function(n){return t[n]});return Function.apply(null,e.concat(n)).apply(null,r)},arguments.length&&o.apply(null,arguments),o};genfun.formats=formats,module.exports=genfun;

},{"is-property":159,"util":254}],129:[function(require,module,exports){
...
},{"is-property":159}],130:[function(require,module,exports){
...
},{"es-errors":118,"es-errors/eval":117,"es-errors/range":119,"es-errors/ref":120,"es-errors/syntax":121,"es-errors/type":122,"es-errors/uri":123,"function-bind":127,"has-proto":133,"has-symbols":134,"hasown":149}],131:[function(require,module,exports){
...
},{"es-define-property":116}],133:[function(require,module,exports){
...
},{"inherits":155,"readable-stream":224,"safe-buffer":227}],137:[function(require,module,exports){
...
},{"./utils":148,"minimalistic-assert":165}],139:[function(require,module,exports){
...
},{"./utils":148,"minimalistic-assert":165}],140:[function(require,module,exports){
...
},{"../common":138,"../utils":148,"./common":147,"minimalistic-assert":165}],145:[function(require,module,exports){
...
},{"../common":138,"../utils":148,"minimalistic-assert":165}],147:[function(require,module,exports){
...
},{"inherits":155,"minimalistic-assert":165}],149:[function(require,module,exports){
...
},{"function-bind":127}],150:[function(require,module,exports){
...
},{"hash.js":137,"minimalistic-assert":165,"minimalistic-crypto-utils":166}],151:[function(require,module,exports){
...
},{"depd":88,"inherits":154,"setprototypeof":229,"statuses":240,"toidentifier":250}],152:[function(require,module,exports){
...
},{"http":242,"url":251}],153:[function(require,module,exports){
...
},{"hash-base":136,"inherits":155,"safe-buffer":227}],164:[function(require,module,exports){
...
},{"bn.js":35,"brorand":43}],165:[function(require,module,exports){
...
},{"./util.inspect":44}],170:[function(require,module,exports){
...
},{"./certificate":172,"asn1.js":19}],172:[function(require,module,exports){
...
},{"./default-encoding":177,"./precondition":178,"./sync":179,"./to-buffer":180,"safe-buffer":227}],177:[function(require,module,exports){
...
},{"./default-encoding":177,"./precondition":178,"./to-buffer":180,"create-hash/md5":83,"ripemd160":225,"safe-buffer":227,"sha.js":231}],180:[function(require,module,exports){
...
},{"safe-buffer":227}],181:[function(require,module,exports){
...
},{"create-hash":82,"safe-buffer":227}],185:[function(require,module,exports){
...
},{"./mgf":184,"./withPublic":187,"./xor":188,"bn.js":35,"browserify-rsa":65,"create-hash":82,"parse-asn1":174,"safe-buffer":227}],186:[function(require,module,exports){
...
},{"./mgf":184,"./withPublic":187,"./xor":188,"bn.js":35,"browserify-rsa":65,"create-hash":82,"parse-asn1":174,"randombytes":195,"safe-buffer":227}],187:[function(require,module,exports){
...
},{"bn.js":35,"safe-buffer":227}],188:[function(require,module,exports){
...
},{"./formats":190}],195:[function(require,module,exports){
(function (process,global){(function (){
...
},{"_process":182,"safe-buffer":227}],196:[function(require,module,exports){
(function (process,global){(function (){
...
},{"_process":182,"randombytes":195,"safe-buffer":227}],197:[function(require,module,exports){
...
},{"./_stream_readable":200,"./_stream_writable":202,"core-util-is":80,"inherits":155,"process-nextick-args":181}],199:[function(require,module,exports){
...
},{"./_stream_transform":201,"core-util-is":80,"inherits":155}],200:[function(require,module,exports){
(function (process,global){(function (){
...
},{"./_stream_duplex":198,"./internal/streams/BufferList":203,"./internal/streams/destroy":204,"./internal/streams/stream":205,"_process":182,"core-util-is":80,"events":124,"inherits":155,"isarray":160,"process-nextick-args":181,"safe-buffer":226,"string_decoder/":246,"util":44}],201:[function(require,module,exports){
...
},{"./_stream_duplex":198,"core-util-is":80,"inherits":155}],202:[function(require,module,exports){
...
},{"./_stream_duplex":198,"./internal/streams/destroy":204,"./internal/streams/stream":205,"_process":182,"core-util-is":80,"inherits":155,"process-nextick-args":181,"safe-buffer":226,"timers":248,"util-deprecate":252}],203:[function(require,module,exports){
...
},{"safe-buffer":226,"util":44}],204:[function(require,module,exports){
...
},{"process-nextick-args":181}],205:[function(require,module,exports){
module.exports=require("events").EventEmitter;

},{"events":124}],206:[function(require,module,exports){
...
},{"./_stream_readable":213,"./_stream_writable":215,"_process":182,"inherits":155}],212:[function(require,module,exports){
...
},{"./_stream_transform":214,"inherits":155}],213:[function(require,module,exports){
(function (process,global){(function (){
...
},{"../errors":210,"./_stream_duplex":211,"./internal/streams/async_iterator":216,"./internal/streams/buffer_list":217,"./internal/streams/destroy":218,"./internal/streams/from":220,"./internal/streams/state":222,"./internal/streams/stream":223,"_process":182,"buffer":75,"events":124,"inherits":155,"string_decoder/":247,"util":44}],214:[function(require,module,exports){
...
},{"../errors":210,"./_stream_duplex":211,"inherits":155}],215:[function(require,module,exports){
(function (process,global){(function (){
...
},{"../errors":210,"./_stream_duplex":211,"./internal/streams/destroy":218,"./internal/streams/state":222,"./internal/streams/stream":223,"_process":182,"buffer":75,"inherits":155,"util-deprecate":252}],216:[function(require,module,exports){
(function (process){(function (){
...
},{"./end-of-stream":219,"_process":182}],217:[function(require,module,exports){
...
},{"buffer":75,"util":44}],218:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":182}],219:[function(require,module,exports){
...
},{"events":124}],224:[function(require,module,exports){
...
},{"buffer":75,"hash-base":136,"inherits":155}],226:[function(require,module,exports){
...
},{"buffer":75}],227:[function(require,module,exports){
...
},{"buffer":75}],228:[function(require,module,exports){
...
},{"define-data-property":87,"es-errors/type":122,"get-intrinsic":130,"gopd":131,"has-property-descriptors":132}],229:[function(require,module,exports){
...
},{"safe-buffer":227}],231:[function(require,module,exports){
...
},{"./hash":230,"inherits":155,"safe-buffer":227}],233:[function(require,module,exports){
...
},{"./hash":230,"inherits":155,"safe-buffer":227}],234:[function(require,module,exports){
...
},{"./hash":230,"./sha256":235,"inherits":155,"safe-buffer":227}],235:[function(require,module,exports){
...
},{"./hash":230,"inherits":155,"safe-buffer":227}],236:[function(require,module,exports){
...
},{"./hash":230,"./sha512":237,"inherits":155,"safe-buffer":227}],237:[function(require,module,exports){
...
},{"./hash":230,"inherits":155,"safe-buffer":227}],238:[function(require,module,exports){
...
},{"call-bind/callBound":77,"es-errors/type":122,"get-intrinsic":130,"object-inspect":169}],239:[function(require,module,exports){
module.exports={
  "100": "Continue",
...
},{"events":124,"inherits":155,"readable-stream/duplex.js":197,"readable-stream/passthrough.js":206,"readable-stream/readable.js":207,"readable-stream/transform.js":208,"readable-stream/writable.js":209}],242:[function(require,module,exports){
(function (global){(function (){
...
},{"./lib/request":244,"./lib/response":245,"builtin-status-codes":76,"url":251,"xtend":256}],243:[function(require,module,exports){
(function (global){(function (){
...
},{"./capability":243,"./response":245,"_process":182,"buffer":75,"inherits":155,"readable-stream":207,"to-arraybuffer":249}],245:[function(require,module,exports){
(function (process,global,Buffer){(function (){
...
},{"./capability":243,"_process":182,"buffer":75,"inherits":155,"readable-stream":207}],246:[function(require,module,exports){
...
},{"safe-buffer":226}],247:[function(require,module,exports){
"use strict";var Buffer=require("safe-buffer").Buffer,isEncoding=Buffer.isEncoding||function(t){switch((t=""+t)&&t.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0;default:return!1}};function _normalizeEncoding(t){if(!t)return"utf8";for(var e;;)switch(t){case"utf8":case"utf-8":return"utf8";case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return"utf16le";case"latin1":case"binary":return"latin1";case"base64":case"ascii":case"hex":return t;default:if(e)return;t=(""+t).toLowerCase(),e=!0}}function normalizeEncoding(t){var e=_normalizeEncoding(t);if("string"!=typeof e&&(Buffer.isEncoding===isEncoding||!isEncoding(t)))throw new Error("Unknown encoding: "+t);return e||t}function StringDecoder(t){var e;switch(this.encoding=normalizeEncoding(t),this.encoding){case"utf16le":this.text=utf16Text,this.end=utf16End,e=4;break;case"utf8":this.fillLast=utf8FillLast,e=4;break;case"base64":this.text=base64Text,this.end=base64End,e=3;break;default:return this.write=simpleWrite,void(this.end=simpleEnd)}this.lastNeed=0,this.lastTotal=0,this.lastChar=Buffer.allocUnsafe(e)}function utf8CheckByte(t){return t<=127?0:t>>5==6?2:t>>4==14?3:t>>3==30?4:t>>6==2?-1:-2}function utf8CheckIncomplete(t,e,s){var i=e.length-1;if(i<s)return 0;var n=utf8CheckByte(e[i]);return n>=0?(n>0&&(t.lastNeed=n-1),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(t.lastNeed=n-2),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(2===n?n=0:t.lastNeed=n-3),n):0}function utf8CheckExtraBytes(t,e,s){if(128!=(192&e[0]))return t.lastNeed=0,"�";if(t.lastNeed>1&&e.length>1){if(128!=(192&e[1]))return t.lastNeed=1,"�";if(t.lastNeed>2&&e.length>2&&128!=(192&e[2]))return t.lastNeed=2,"�"}}function utf8FillLast(t){var e=this.lastTotal-this.lastNeed,s=utf8CheckExtraBytes(this,t,e);return void 0!==s?s:this.lastNeed<=t.length?(t.copy(this.lastChar,e,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal)):(t.copy(this.lastChar,e,0,t.length),void(this.lastNeed-=t.length))}function utf8Text(t,e){var s=utf8CheckIncomplete(this,t,e);if(!this.lastNeed)return t.toString("utf8",e);this.lastTotal=s;var i=t.length-(s-this.lastNeed);return t.copy(this.lastChar,0,i),t.toString("utf8",e,i)}function utf8End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+"�":e}function utf16Text(t,e){if((t.length-e)%2==0){var s=t.toString("utf16le",e);if(s){var i=s.charCodeAt(s.length-1);if(i>=55296&&i<=56319)return this.lastNeed=2,this.lastTotal=4,this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1],s.slice(0,-1)}return s}return this.lastNeed=1,this.lastTotal=2,this.lastChar[0]=t[t.length-1],t.toString("utf16le",e,t.length-1)}function utf16End(t){var e=t&&t.length?this.write(t):"";if(this.lastNeed){var s=this.lastTotal-this.lastNeed;return e+this.lastChar.toString("utf16le",0,s)}return e}function base64Text(t,e){var s=(t.length-e)%3;return 0===s?t.toString("base64",e):(this.lastNeed=3-s,this.lastTotal=3,1===s?this.lastChar[0]=t[t.length-1]:(this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1]),t.toString("base64",e,t.length-s))}function base64End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+this.lastChar.toString("base64",0,3-this.lastNeed):e}function simpleWrite(t){return t.toString(this.encoding)}function simpleEnd(t){return t&&t.length?this.write(t):""}exports.StringDecoder=StringDecoder,StringDecoder.prototype.write=function(t){if(0===t.length)return"";var e,s;if(this.lastNeed){if(void 0===(e=this.fillLast(t)))return"";s=this.lastNeed,this.lastNeed=0}else s=0;return s<t.length?e?e+this.text(t,s):this.text(t,s):e||""},StringDecoder.prototype.end=utf8End,StringDecoder.prototype.text=utf8Text,StringDecoder.prototype.fillLast=function(t){if(this.lastNeed<=t.length)return t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,t.length),this.lastNeed-=t.length};

},{"safe-buffer":227}],248:[function(require,module,exports){
...
},{"process/browser.js":182,"timers":248}],249:[function(require,module,exports){
...
},{"buffer":75}],250:[function(require,module,exports){
...
},{"./support/isBuffer":253,"_process":182,"inherits":154}],255:[function(require,module,exports){
...
},{"@near-js/providers":319}],260:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"./account":257,"./constants":262,"./types":269,"@near-js/transactions":329,"@near-js/utils":347,"buffer":75}],261:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Connection=void 0;const signers_1=require("@near-js/signers"),providers_1=require("@near-js/providers");function getProvider(e){switch(e.type){case void 0:return e;case"JsonRpcProvider":return new providers_1.JsonRpcProvider(Object.assign({},e.args));case"FailoverRpcProvider":{const r=((null==e?void 0:e.args)||[]).map(e=>new providers_1.JsonRpcProvider(e));return new providers_1.FailoverRpcProvider(r)}default:throw new Error(`Unknown provider type ${e.type}`)}}function getSigner(e){switch(e.type){case void 0:return e;case"InMemorySigner":return new signers_1.InMemorySigner(e.keyStore);default:throw new Error(`Unknown signer type ${e.type}`)}}class Connection{constructor(e,r,n,o){this.networkId=e,this.provider=r,this.signer=n,this.jsvmAccountId=o}getConnection(){return this}static fromConfig(e){const r=getProvider(e.provider),n=getSigner(e.signer);return new Connection(e.networkId,r,n,e.jsvmAccountId)}}exports.Connection=Connection;

},{"@near-js/providers":319,"@near-js/signers":323}],262:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.MULTISIG_CONFIRM_METHODS=exports.MULTISIG_CHANGE_METHODS=exports.MULTISIG_DEPOSIT=exports.MULTISIG_GAS=exports.MULTISIG_ALLOWANCE=exports.MULTISIG_STORAGE_KEY=void 0;const utils_1=require("@near-js/utils");exports.MULTISIG_STORAGE_KEY="__multisigRequest",exports.MULTISIG_ALLOWANCE=BigInt((0,utils_1.parseNearAmount)("1")),exports.MULTISIG_GAS=BigInt("100000000000000"),exports.MULTISIG_DEPOSIT=BigInt("0"),exports.MULTISIG_CHANGE_METHODS=["add_request","add_request_and_confirm","delete_request","confirm"],exports.MULTISIG_CONFIRM_METHODS=["confirm"];

},{"@near-js/utils":347}],263:[function(require,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(t,e,n,i){return new(n||(n=Promise))(function(a,r){function o(t){try{c(i.next(t))}catch(t){r(t)}}function s(t){try{c(i.throw(t))}catch(t){r(t)}}function c(t){var e;t.done?a(t.value):(e=t.value,e instanceof n?e:new n(function(t){t(e)})).then(o,s)}c((i=i.apply(t,e||[])).next())})},__importDefault=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.Contract=void 0;const utils_1=require("@near-js/utils"),types_1=require("@near-js/types"),local_view_execution_1=require("./local-view-execution"),is_my_json_valid_1=__importDefault(require("is-my-json-valid")),depd_1=__importDefault(require("depd")),near_abi_1=require("near-abi"),account_1=require("./account"),errors_1=require("./errors"),utils_2=require("./utils");function nameFunction(t,e){return{[t]:(...t)=>e(...t)}[t]}function validateArguments(t,e,n){var i;if(!isObject(t))return;if(e.params&&e.params.serialization_type!==near_abi_1.AbiSerializationType.Json)throw new errors_1.UnsupportedSerializationError(e.name,e.params.serialization_type);if(e.result&&e.result.serialization_type!==near_abi_1.AbiSerializationType.Json)throw new errors_1.UnsupportedSerializationError(e.name,e.result.serialization_type);const a=(null===(i=e.params)||void 0===i?void 0:i.args)||[];for(const e of a){const i=t[e.name],a=e.type_schema;a.definitions=n.body.root_schema.definitions;const r=(0,is_my_json_valid_1.default)(a);if(!r(i))throw new errors_1.ArgumentSchemaError(e.name,r.errors)}for(const e of Object.keys(t)){if(!a.find(t=>t.name===e))throw new errors_1.UnknownArgumentError(e,a.map(t=>t.name))}}const isUint8Array=t=>t&&void 0!==t.byteLength&&t.byteLength===t.length,isObject=t=>"[object Object]"===Object.prototype.toString.call(t);class Contract{constructor(t,e,n){if(this.connection=t.getConnection(),t instanceof account_1.Account){(0,depd_1.default)("new Contract(account, contractId, options)")("use `new Contract(connection, contractId, options)` instead"),this.account=t}this.contractId=e,this.lve=new local_view_execution_1.LocalViewExecution(t);const{viewMethods:i=[],changeMethods:a=[],abi:r,useLocalViewExecution:o}=n;let s=i.map(t=>({name:t,abi:null})),c=a.map(t=>({name:t,abi:null}));if(r){if(s.length>0||c.length>0)throw new errors_1.ConflictingOptions;s=r.body.functions.filter(t=>t.kind===near_abi_1.AbiFunctionKind.View).map(t=>({name:t.name,abi:t})),c=r.body.functions.filter(t=>t.kind===near_abi_1.AbiFunctionKind.Call).map(t=>({name:t.name,abi:t}))}s.forEach(({name:t,abi:e})=>{Object.defineProperty(this,t,{writable:!1,enumerable:!0,value:nameFunction(t,(n={},i={},...a)=>__awaiter(this,void 0,void 0,function*(){if(a.length||!isObject(n)&&!isUint8Array(n)||!isObject(i))throw new types_1.PositionalArgsError;if(e&&validateArguments(n,e,r),o)try{return yield this.lve.viewFunction(Object.assign({contractId:this.contractId,methodName:t,args:n},i))}catch(t){utils_1.Logger.warn(`Local view execution failed with: "${t.message}"`),utils_1.Logger.warn("Fallback to normal RPC call")}return this.account?this.account.viewFunction(Object.assign({contractId:this.contractId,methodName:t,args:n},i)):(0,utils_2.viewFunction)(this.connection,Object.assign({contractId:this.contractId,methodName:t,args:n},i))}))})}),c.forEach(({name:t,abi:e})=>{Object.defineProperty(this,t,{writable:!1,enumerable:!0,value:nameFunction(t,(...n)=>__awaiter(this,void 0,void 0,function*(){if(n.length&&(n.length>3||!isObject(n[0])&&!isUint8Array(n[0])))throw new types_1.PositionalArgsError;if(n.length>1||!n[0]||!n[0].args){(0,depd_1.default)("contract.methodName(args, gas, amount)")("use `contract.methodName({ signerAccount, args, gas?, amount?, callbackUrl?, meta? })` instead"),n[0]={args:n[0],gas:n[1],amount:n[2]}}return e&&validateArguments(n[0].args,e,r),this._changeMethod(Object.assign({methodName:t},n[0]))}))})})}_changeMethod({signerAccount:t,args:e,methodName:n,gas:i,amount:a,meta:r,callbackUrl:o}){return __awaiter(this,void 0,void 0,function*(){validateBNLike({gas:i,amount:a});const s=this.account||t;if(!s)throw new Error("signerAccount must be specified");const c=yield s.functionCall({contractId:this.contractId,methodName:n,args:e,gas:i,attachedDeposit:a,walletMeta:r,walletCallbackUrl:o});return(0,utils_1.getTransactionLastResult)(c)})}}function validateBNLike(t){for(const e of Object.keys(t)){const n=t[e];if(n&&"bigint"!=typeof n&&isNaN(n))throw new types_1.ArgumentTypeError(e,"number, decimal string or BigInt",n)}}exports.Contract=Contract;

},{"./account":257,"./errors":264,"./local-view-execution":266,"./utils":270,"@near-js/types":336,"@near-js/utils":347,"depd":89,"is-my-json-valid":158,"near-abi":168}],264:[function(require,module,exports){
...
},{"./account":257,"./account_2fa":258,"./account_creator":259,"./account_multisig":260,"./connection":261,"./constants":262,"./contract":263,"./errors":264,"./types":269}],266:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";var __awaiter=this&&this.__awaiter||function(t,e,o,r){return new(o||(o=Promise))(function(i,n){function c(t){try{s(r.next(t))}catch(t){n(t)}}function a(t){try{s(r.throw(t))}catch(t){n(t)}}function s(t){var e;t.done?i(t.value):(e=t.value,e instanceof o?e:new o(function(t){t(e)})).then(c,a)}s((r=r.apply(t,e||[])).next())})},__rest=this&&this.__rest||function(t,e){var o={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(o[r]=t[r]);if(null!=t&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(o[r[i]]=t[r[i]])}return o};Object.defineProperty(exports,"__esModule",{value:!0}),exports.LocalViewExecution=void 0;const utils_1=require("@near-js/utils"),storage_1=require("./storage"),runtime_1=require("./runtime"),utils_2=require("../utils");class LocalViewExecution{constructor(t){this.connection=t.getConnection(),this.storage=new storage_1.Storage}fetchContractCode(t,e){return __awaiter(this,void 0,void 0,function*(){return(yield this.connection.provider.query(Object.assign({request_type:"view_code",account_id:t},e))).code_base64})}fetchContractState(t,e){return __awaiter(this,void 0,void 0,function*(){return(0,utils_2.viewState)(this.connection,t,"",e)})}fetch(t,e){return __awaiter(this,void 0,void 0,function*(){const o=yield this.connection.provider.block(e);return{blockHash:o.header.hash,blockHeight:o.header.height,blockTimestamp:o.header.timestamp,contractCode:yield this.fetchContractCode(t,e),contractState:yield this.fetchContractState(t,e)}})}loadOrFetch(t,e){return __awaiter(this,void 0,void 0,function*(){const o=this.storage.load(e);if(o)return o;const r=yield this.fetch(t,e),{blockHash:i}=r,n=__rest(r,["blockHash"]);return this.storage.save(i,n),n})}viewFunction(t){var{contractId:e,methodName:o,args:r={},blockQuery:i={finality:"optimistic"}}=t;__rest(t,["contractId","methodName","args","blockQuery"]);return __awaiter(this,void 0,void 0,function*(){const t=JSON.stringify(r),{contractCode:n,contractState:c,blockHeight:a,blockTimestamp:s}=yield this.loadOrFetch(e,i),u=new runtime_1.Runtime({contractId:e,contractCode:n,contractState:c,blockHeight:a,blockTimestamp:s,methodArgs:t}),{result:l,logs:h}=yield u.execute(o);return h&&(0,utils_1.printTxOutcomeLogs)({contractId:e,logs:h}),JSON.parse(Buffer.from(l).toString())})}}exports.LocalViewExecution=LocalViewExecution;

}).call(this)}).call(this,require("buffer").Buffer)
},{"../utils":270,"./runtime":267,"./storage":268,"@near-js/utils":347,"buffer":75}],267:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":75,"crypto":86}],268:[function(require,module,exports){
...
},{"lru_map":162}],269:[function(require,module,exports){
...
(function (Buffer){(function (){
"use strict";var __awaiter=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))(function(o,i){function s(e){try{c(n.next(e))}catch(e){i(e)}}function a(e){try{c(n.throw(e))}catch(e){i(e)}}function c(e){var t;e.done?o(e.value):(t=e.value,t instanceof r?t:new r(function(e){e(t)})).then(s,a)}c((n=n.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.viewFunction=exports.viewState=exports.encodeJSContractArgs=exports.validateArgs=void 0;const types_1=require("@near-js/types"),utils_1=require("@near-js/utils");function parseJsonFromRawResponse(e){return JSON.parse(Buffer.from(e).toString())}function bytesJsonStringify(e){return Buffer.from(JSON.stringify(e))}function validateArgs(e){if(!(void 0!==e.byteLength&&e.byteLength===e.length)&&(Array.isArray(e)||"object"!=typeof e))throw new types_1.PositionalArgsError}function encodeJSContractArgs(e,t,r){return Buffer.concat([Buffer.from(e),Buffer.from([0]),Buffer.from(t),Buffer.from([0]),Buffer.from(r)])}function viewState(e,t,r,n={finality:"optimistic"}){return __awaiter(this,void 0,void 0,function*(){const{values:o}=yield e.provider.query(Object.assign(Object.assign({request_type:"view_state"},n),{account_id:t,prefix_base64:Buffer.from(r).toString("base64")}));return o.map(({key:e,value:t})=>({key:Buffer.from(e,"base64"),value:Buffer.from(t,"base64")}))})}function viewFunction(e,{contractId:t,methodName:r,args:n={},parse:o=parseJsonFromRawResponse,stringify:i=bytesJsonStringify,jsContract:s=!1,blockQuery:a={finality:"optimistic"}}){return __awaiter(this,void 0,void 0,function*(){let c;validateArgs(n),c=s?encodeJSContractArgs(t,r,Object.keys(n).length>0?JSON.stringify(n):""):i(n);const u=yield e.provider.query(Object.assign(Object.assign({request_type:"call_function"},a),{account_id:s?e.jsvmAccountId:t,method_name:s?"view_js_contract":r,args_base64:c.toString("base64")}));return u.logs&&(0,utils_1.printTxOutcomeLogs)({contractId:t,logs:u.logs}),u.result&&u.result.length>0&&o(Buffer.from(u.result))})}exports.validateArgs=validateArgs,exports.encodeJSContractArgs=encodeJSContractArgs,exports.viewState=viewState,exports.viewFunction=viewFunction;

}).call(this)}).call(this,require("buffer").Buffer)
},{"@near-js/types":336,"@near-js/utils":347,"buffer":75}],271:[function(require,module,exports){
...
},{"./constants":271,"./key_pair":273,"./key_pair_ed25519":275,"./public_key":276}],273:[function(require,module,exports){
...
},{"./key_pair_base":274,"./key_pair_ed25519":275}],274:[function(require,module,exports){
...
},{"./constants":271,"@near-js/types":336,"@near-js/utils":347,"@noble/curves/ed25519":7}],277:[function(require,module,exports){
...
},{"@near-js/crypto":272,"@near-js/keystores":280}],278:[function(require,module,exports){
...
},{"./browser_local_storage_key_store":277}],279:[function(require,module,exports){
...
},{"./keystore":281,"@near-js/crypto":272}],280:[function(require,module,exports){
...
},{"./in_memory_key_store":279,"./keystore":281,"./merge_key_store":282}],281:[function(require,module,exports){
...
},{"./keystore":281}],283:[function(require,module,exports){
(function (Buffer){(function (){
window.nearApi=require("./lib/browser-index"),window.Buffer=Buffer;

}).call(this)}).call(this,require("buffer").Buffer)
},{"./lib/browser-index":288,"buffer":75}],284:[function(require,module,exports){
...
},{"@near-js/accounts":265}],285:[function(require,module,exports){
...
},{"@near-js/accounts":265}],286:[function(require,module,exports){
...
},{"@near-js/accounts":265}],287:[function(require,module,exports){
...
},{"./near":297}],288:[function(require,module,exports){
...
},{"./browser-connect":287,"./common-index":289,"./key_stores/browser-index":292}],289:[function(require,module,exports){
...
},{"./account":284,"./account_creator":285,"./account_multisig":286,"./connection":290,"./contract":291,"./near":297,"./providers":299,"./signer":302,"./transaction":303,"./utils":307,"./utils/key_pair":308,"./validators":313,"./wallet-account":314}],290:[function(require,module,exports){
...
},{"@near-js/accounts":265}],291:[function(require,module,exports){
...
},{"@near-js/accounts":265}],292:[function(require,module,exports){
...
},{"./browser_local_storage_key_store":293,"./in_memory_key_store":294,"./keystore":295,"./merge_key_store":296}],293:[function(require,module,exports){
...
},{"@near-js/keystores-browser":278}],294:[function(require,module,exports){
...
},{"@near-js/keystores":280}],295:[function(require,module,exports){
...
},{"@near-js/keystores":280}],296:[function(require,module,exports){
...
},{"@near-js/keystores":280}],297:[function(require,module,exports){
...
},{"@near-js/wallet-account":355}],298:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.FailoverRpcProvider=void 0;var providers_1=require("@near-js/providers");Object.defineProperty(exports,"FailoverRpcProvider",{enumerable:!0,get:function(){return providers_1.FailoverRpcProvider}});

},{"@near-js/providers":319}],299:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.ErrorContext=exports.TypedError=exports.getTransactionLastResult=exports.FinalExecutionStatusBasic=exports.FailoverRpcProvider=exports.JsonRpcProvider=exports.Provider=void 0;const provider_1=require("./provider");Object.defineProperty(exports,"Provider",{enumerable:!0,get:function(){return provider_1.Provider}}),Object.defineProperty(exports,"getTransactionLastResult",{enumerable:!0,get:function(){return provider_1.getTransactionLastResult}}),Object.defineProperty(exports,"FinalExecutionStatusBasic",{enumerable:!0,get:function(){return provider_1.FinalExecutionStatusBasic}});const json_rpc_provider_1=require("./json-rpc-provider");Object.defineProperty(exports,"JsonRpcProvider",{enumerable:!0,get:function(){return json_rpc_provider_1.JsonRpcProvider}}),Object.defineProperty(exports,"TypedError",{enumerable:!0,get:function(){return json_rpc_provider_1.TypedError}}),Object.defineProperty(exports,"ErrorContext",{enumerable:!0,get:function(){return json_rpc_provider_1.ErrorContext}});const failover_rpc_provider_1=require("./failover-rpc-provider");Object.defineProperty(exports,"FailoverRpcProvider",{enumerable:!0,get:function(){return failover_rpc_provider_1.FailoverRpcProvider}});

},{"./failover-rpc-provider":298,"./json-rpc-provider":300,"./provider":301}],300:[function(require,module,exports){
...
},{"@near-js/providers":319,"@near-js/types":336}],301:[function(require,module,exports){
...
},{"@near-js/providers":319,"@near-js/types":336,"@near-js/utils":347}],302:[function(require,module,exports){
...
},{"@near-js/signers":323}],303:[function(require,module,exports){
...
},{"@near-js/transactions":329}],304:[function(require,module,exports){
...
},{"@near-js/types":336}],305:[function(require,module,exports){
...
},{"@near-js/accounts":265,"@near-js/types":336,"@near-js/utils":347}],306:[function(require,module,exports){
...
},{"@near-js/utils":347}],307:[function(require,module,exports){
...
},{"./enums":304,"./errors":305,"./format":306,"./key_pair":308,"./logger":309,"./rpc_errors":310,"./serialize":311,"./web":312}],308:[function(require,module,exports){
...
},{"@near-js/crypto":272}],309:[function(require,module,exports){
...
},{"@near-js/utils":347}],310:[function(require,module,exports){
...
},{"@near-js/utils":347}],311:[function(require,module,exports){
...
},{"@near-js/utils":347,"borsh":39}],312:[function(require,module,exports){
...
},{"@near-js/providers":319}],313:[function(require,module,exports){
...
},{"@near-js/utils":347}],314:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.WalletConnection=exports.ConnectedWalletAccount=void 0;var wallet_account_1=require("@near-js/wallet-account");Object.defineProperty(exports,"ConnectedWalletAccount",{enumerable:!0,get:function(){return wallet_account_1.ConnectedWalletAccount}}),Object.defineProperty(exports,"WalletConnection",{enumerable:!0,get:function(){return wallet_account_1.WalletConnection}});

},{"@near-js/wallet-account":355}],315:[function(require,module,exports){
...
"use strict";var __awaiter=this&&this.__awaiter||function(t,i,r,e){return new(r||(r=Promise))(function(n,o){function s(t){try{c(e.next(t))}catch(t){o(t)}}function a(t){try{c(e.throw(t))}catch(t){o(t)}}function c(t){var i;t.done?n(t.value):(i=t.value,i instanceof r?i:new r(function(t){t(i)})).then(s,a)}c((e=e.apply(t,i||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.FailoverRpcProvider=void 0;const utils_1=require("@near-js/utils"),types_1=require("@near-js/types"),provider_1=require("./provider");class FailoverRpcProvider extends provider_1.Provider{constructor(t){if(super(),0===t.length)throw new Error("At least one provider must be specified");this.providers=t,this.currentProviderIndex=0}switchToNextProvider(){1!==this.providers.length&&(this.providers.length-1<=this.currentProviderIndex?this.currentProviderIndex=0:this.currentProviderIndex+=1,utils_1.Logger.debug(`Switched to provider at the index ${this.currentProviderIndex}`))}get currentProvider(){const t=this.providers[this.currentProviderIndex];if(!t)throw new Error(`Provider wasn't found at index ${this.currentProviderIndex}`);return t}withBackoff(t){return __awaiter(this,void 0,void 0,function*(){for(let i=0;i<this.providers.length;i++)try{const i=yield t(this.currentProvider);if(i)return i}catch(t){this.switchToNextProvider()}throw new types_1.TypedError(`Exceeded ${this.providers.length} providers to execute request`,"RetriesExceeded")})}status(){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(t=>t.status())})}sendTransactionUntil(t,i){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(r=>r.sendTransactionUntil(t,i))})}sendTransaction(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.sendTransaction(t))})}sendTransactionAsync(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.sendTransactionAsync(t))})}txStatus(t,i,r){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(e=>e.txStatus(t,i,r))})}txStatusReceipts(t,i,r){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(e=>e.txStatusReceipts(t,i,r))})}query(t,i){return __awaiter(this,void 0,void 0,function*(){return i?this.withBackoff(r=>r.query(t,i)):this.withBackoff(i=>i.query(t))})}block(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.block(t))})}blockChanges(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.blockChanges(t))})}chunk(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.chunk(t))})}validators(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.validators(t))})}experimental_protocolConfig(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.experimental_protocolConfig(t))})}lightClientProof(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.lightClientProof(t))})}nextLightClientBlock(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.nextLightClientBlock(t))})}accessKeyChanges(t,i){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(r=>r.accessKeyChanges(t,i))})}singleAccessKeyChanges(t,i){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(r=>r.singleAccessKeyChanges(t,i))})}accountChanges(t,i){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(r=>r.accountChanges(t,i))})}contractStateChanges(t,i,r=""){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(e=>e.contractStateChanges(t,i,r))})}contractCodeChanges(t,i){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(r=>r.contractCodeChanges(t,i))})}gasPrice(t){return __awaiter(this,void 0,void 0,function*(){return this.withBackoff(i=>i.gasPrice(t))})}}exports.FailoverRpcProvider=FailoverRpcProvider;

},{"./provider":321,"@near-js/types":336,"@near-js/utils":347}],317:[function(require,module,exports){
...
},{"http":242,"https":152,"node-fetch":72}],318:[function(require,module,exports){
(function (global){(function (){
...
},{"./exponential-backoff":315,"./fetch":317,"@near-js/types":336,"@near-js/utils":347,"http-errors":151}],319:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.fetchJson=exports.Provider=exports.FailoverRpcProvider=exports.JsonRpcProvider=exports.exponentialBackoff=void 0;var exponential_backoff_1=require("./exponential-backoff");Object.defineProperty(exports,"exponentialBackoff",{enumerable:!0,get:function(){return exponential_backoff_1.exponentialBackoff}});var json_rpc_provider_1=require("./json-rpc-provider");Object.defineProperty(exports,"JsonRpcProvider",{enumerable:!0,get:function(){return json_rpc_provider_1.JsonRpcProvider}});var failover_rpc_provider_1=require("./failover-rpc-provider");Object.defineProperty(exports,"FailoverRpcProvider",{enumerable:!0,get:function(){return failover_rpc_provider_1.FailoverRpcProvider}});var provider_1=require("./provider");Object.defineProperty(exports,"Provider",{enumerable:!0,get:function(){return provider_1.Provider}});var fetch_json_1=require("./fetch_json");Object.defineProperty(exports,"fetchJson",{enumerable:!0,get:function(){return fetch_json_1.fetchJson}});

},{"./exponential-backoff":315,"./failover-rpc-provider":316,"./fetch_json":318,"./json-rpc-provider":320,"./provider":321}],320:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";var __awaiter=this&&this.__awaiter||function(t,r,e,n){return new(e||(e=Promise))(function(i,o){function s(t){try{c(n.next(t))}catch(t){o(t)}}function a(t){try{c(n.throw(t))}catch(t){o(t)}}function c(t){var r;t.done?i(t.value):(r=t.value,r instanceof e?r:new e(function(t){t(r)})).then(s,a)}c((n=n.apply(t,r||[])).next())})},__rest=this&&this.__rest||function(t,r){var e={};for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&r.indexOf(n)<0&&(e[n]=t[n]);if(null!=t&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(n=Object.getOwnPropertySymbols(t);i<n.length;i++)r.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(t,n[i])&&(e[n[i]]=t[n[i]])}return e};Object.defineProperty(exports,"__esModule",{value:!0}),exports.JsonRpcProvider=void 0;const utils_1=require("@near-js/utils"),types_1=require("@near-js/types"),transactions_1=require("@near-js/transactions"),exponential_backoff_1=require("./exponential-backoff"),provider_1=require("./provider"),fetch_json_1=require("./fetch_json"),REQUEST_RETRY_NUMBER=12,REQUEST_RETRY_WAIT=500,REQUEST_RETRY_WAIT_BACKOFF=1.5;let _nextId=123;class JsonRpcProvider extends provider_1.Provider{constructor(t,r){super(),this.connection=t||{url:""};const e={retries:REQUEST_RETRY_NUMBER,wait:REQUEST_RETRY_WAIT,backoff:REQUEST_RETRY_WAIT_BACKOFF};this.options=Object.assign({},e,r)}status(){return __awaiter(this,void 0,void 0,function*(){return this.sendJsonRpc("status",[])})}sendTransactionUntil(t,r){return __awaiter(this,void 0,void 0,function*(){const e=(0,transactions_1.encodeTransaction)(t);return this.sendJsonRpc("send_tx",{signed_tx_base64:Buffer.from(e).toString("base64"),wait_until:r})})}sendTransaction(t){return __awaiter(this,void 0,void 0,function*(){return this.sendTransactionUntil(t,"FINAL")})}sendTransactionAsync(t){return __awaiter(this,void 0,void 0,function*(){return this.sendTransactionUntil(t,"NONE")})}txStatus(t,r,e="FINAL"){return __awaiter(this,void 0,void 0,function*(){return"string"==typeof t?this.txStatusString(t,r,e):this.txStatusUint8Array(t,r,e)})}txStatusUint8Array(t,r,e){return __awaiter(this,void 0,void 0,function*(){return this.sendJsonRpc("tx",{tx_hash:(0,utils_1.baseEncode)(t),sender_account_id:r,wait_until:e})})}txStatusString(t,r,e){return __awaiter(this,void 0,void 0,function*(){return this.sendJsonRpc("tx",{tx_hash:t,sender_account_id:r,wait_until:e})})}txStatusReceipts(t,r,e="FINAL"){return __awaiter(this,void 0,void 0,function*(){return"string"==typeof t?this.sendJsonRpc("EXPERIMENTAL_tx_status",{tx_hash:t,sender_account_id:r,wait_until:e}):this.sendJsonRpc("EXPERIMENTAL_tx_status",{tx_hash:(0,utils_1.baseEncode)(t),sender_account_id:r,wait_until:e})})}query(...t){return __awaiter(this,void 0,void 0,function*(){let r;if(1===t.length){const e=t[0],{block_id:n,blockId:i}=e,o=__rest(e,["block_id","blockId"]);r=yield this.sendJsonRpc("query",Object.assign(Object.assign({},o),{block_id:n||i}))}else{const[e,n]=t;r=yield this.sendJsonRpc("query",[e,n])}if(r&&r.error)throw new types_1.TypedError(`Querying failed: ${r.error}.\n${JSON.stringify(r,null,2)}`,(0,utils_1.getErrorTypeFromErrorMessage)(r.error,r.error.name));return r})}block(t){return __awaiter(this,void 0,void 0,function*(){const{finality:r}=t,{blockId:e}=t;return this.sendJsonRpc("block",{block_id:e,finality:r})})}blockChanges(t){return __awaiter(this,void 0,void 0,function*(){const{finality:r}=t,{blockId:e}=t;return this.sendJsonRpc("EXPERIMENTAL_changes_in_block",{block_id:e,finality:r})})}chunk(t){return __awaiter(this,void 0,void 0,function*(){return this.sendJsonRpc("chunk",[t])})}validators(t){return __awaiter(this,void 0,void 0,function*(){return this.sendJsonRpc("validators",[t])})}experimental_protocolConfig(t){return __awaiter(this,void 0,void 0,function*(){const r=t,{blockId:e}=r,n=__rest(r,["blockId"]);return yield this.sendJsonRpc("EXPERIMENTAL_protocol_config",Object.assign(Object.assign({},n),{block_id:e}))})}lightClientProof(t){return __awaiter(this,void 0,void 0,function*(){return yield this.sendJsonRpc("EXPERIMENTAL_light_client_proof",t)})}nextLightClientBlock(t){return __awaiter(this,void 0,void 0,function*(){return yield this.sendJsonRpc("next_light_client_block",t)})}accessKeyChanges(t,r){return __awaiter(this,void 0,void 0,function*(){const{finality:e}=r,{blockId:n}=r;return this.sendJsonRpc("EXPERIMENTAL_changes",{changes_type:"all_access_key_changes",account_ids:t,block_id:n,finality:e})})}singleAccessKeyChanges(t,r){return __awaiter(this,void 0,void 0,function*(){const{finality:e}=r,{blockId:n}=r;return this.sendJsonRpc("EXPERIMENTAL_changes",{changes_type:"single_access_key_changes",keys:t,block_id:n,finality:e})})}accountChanges(t,r){return __awaiter(this,void 0,void 0,function*(){const{finality:e}=r,{blockId:n}=r;return this.sendJsonRpc("EXPERIMENTAL_changes",{changes_type:"account_changes",account_ids:t,block_id:n,finality:e})})}contractStateChanges(t,r,e=""){return __awaiter(this,void 0,void 0,function*(){const{finality:n}=r,{blockId:i}=r;return this.sendJsonRpc("EXPERIMENTAL_changes",{changes_type:"data_changes",account_ids:t,key_prefix_base64:e,block_id:i,finality:n})})}contractCodeChanges(t,r){return __awaiter(this,void 0,void 0,function*(){const{finality:e}=r,{blockId:n}=r;return this.sendJsonRpc("EXPERIMENTAL_changes",{changes_type:"contract_code_changes",account_ids:t,block_id:n,finality:e})})}gasPrice(t){return __awaiter(this,void 0,void 0,function*(){return yield this.sendJsonRpc("gas_price",[t])})}sendJsonRpc(t,r){return __awaiter(this,void 0,void 0,function*(){const e=yield(0,exponential_backoff_1.exponentialBackoff)(this.options.wait,this.options.retries,this.options.backoff,()=>__awaiter(this,void 0,void 0,function*(){var e;try{const n={method:t,params:r,id:_nextId++,jsonrpc:"2.0"},i=yield(0,fetch_json_1.fetchJson)(this.connection,JSON.stringify(n));if(i.error){if("object"==typeof i.error.data){if("string"==typeof i.error.data.error_message&&"string"==typeof i.error.data.error_type)throw new types_1.TypedError(i.error.data.error_message,i.error.data.error_type);throw(0,utils_1.parseRpcError)(i.error.data)}{const t=`[${i.error.code}] ${i.error.message}: ${i.error.data}`;if("Timeout"===i.error.data||t.includes("Timeout error")||t.includes("query has timed out"))throw new types_1.TypedError(t,"TimeoutError");const e=(0,utils_1.getErrorTypeFromErrorMessage)(i.error.data,"");if(e)throw new types_1.TypedError((0,utils_1.formatError)(e,r),e);throw new types_1.TypedError(t,i.error.name)}}if("string"==typeof(null===(e=i.result)||void 0===e?void 0:e.error)){const t=(0,utils_1.getErrorTypeFromErrorMessage)(i.result.error,"");if(t)throw new utils_1.ServerError((0,utils_1.formatError)(t,r),t)}return i}catch(e){if("TimeoutError"===e.type)return utils_1.Logger.warn(`Retrying request to ${t} as it has timed out`,r),null;throw e}})),{result:n}=e;if(void 0===n)throw new types_1.TypedError(`Exceeded ${this.options.retries} attempts for request to ${t}.`,"RetriesExceeded");return n})}}exports.JsonRpcProvider=JsonRpcProvider;

}).call(this)}).call(this,require("buffer").Buffer)
},{"./exponential-backoff":315,"./fetch_json":318,"./provider":321,"@near-js/transactions":329,"@near-js/types":336,"@near-js/utils":347,"buffer":75}],321:[function(require,module,exports){
...
},{"./signer":324,"@near-js/crypto":272,"@near-js/keystores":280,"@noble/hashes/sha256":17}],323:[function(require,module,exports){
...
},{"./in_memory_signer":322,"./signer":324}],324:[function(require,module,exports){
...
},{"@near-js/types":336}],327:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createTransaction=void 0;const schema_1=require("./schema");function createTransaction(e,t,n,c,r,a){const s="bigint"==typeof c?c:BigInt(c);return new schema_1.Transaction({signerId:e,publicKey:t,nonce:s,receiverId:n,actions:r,blockHash:a})}exports.createTransaction=createTransaction;

},{"./schema":331}],328:[function(require,module,exports){
...
},{"./action_creators":325,"@near-js/types":336}],329:[function(require,module,exports){
...
},{"./action_creators":325,"./actions":326,"./create_transaction":327,"./delegate":328,"./schema":331,"./sign":332,"./signature":333}],330:[function(require,module,exports){
...
},{"@near-js/types":336}],331:[function(require,module,exports){
...
},{"./prefix":330,"@near-js/types":336,"borsh":39}],332:[function(require,module,exports){
...
},{"./actions":326,"./create_transaction":327,"./schema":331,"./signature":333,"@noble/hashes/sha256":17}],333:[function(require,module,exports){
...
},{"@near-js/types":336}],334:[function(require,module,exports){
...
},{"./assignable":334,"./errors":335,"./provider":337}],337:[function(require,module,exports){
...
},{"./light_client":338,"./response":339}],338:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.DEFAULT_FUNCTION_CALL_GAS=void 0,exports.DEFAULT_FUNCTION_CALL_GAS=BigInt("30000000000000");
...
},{"../logger":349}],343:[function(require,module,exports){
...
},{"./errors":342,"./rpc_errors":345}],344:[function(require,module,exports){
module.exports={
    "schema": {
        "AccessKeyNotFound": {
...
},{"./logger":350}],350:[function(require,module,exports){
(function (process){(function (){
...
},{"./console.logger":348,"_process":182}],351:[function(require,module,exports){
...
},{"./errors":343,"./logger":349}],352:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":75}],353:[function(require,module,exports){
"use strict";function sortBigIntAsc(t,s){return t<s?-1:t>s?1:0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.sortBigIntAsc=void 0,exports.sortBigIntAsc=sortBigIntAsc;

},{}],354:[function(require,module,exports){
"use strict";var __importDefault=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0}),exports.diffEpochValidators=exports.findSeatPrice=void 0;const depd_1=__importDefault(require("depd")),utils_1=require("./utils");function findSeatPrice(t,e,i,r){if(r&&r<49)return findSeatPriceForProtocolBefore49(t,e);if(!i){(0,depd_1.default)("findSeatPrice(validators, maxNumberOfSeats)")("`use `findSeatPrice(validators, maxNumberOfSeats, minimumStakeRatio)` instead"),i=[1,6250]}return findSeatPriceForProtocolAfter49(t,e,i)}function findSeatPriceForProtocolBefore49(t,e){const i=t.map(t=>BigInt(t.stake)).sort(utils_1.sortBigIntAsc),r=BigInt(e),o=i.reduce((t,e)=>t+e);if(o<r)throw new Error("Stakes are below seats");let a=BigInt(1),n=o+BigInt(1);for(;a!==n-BigInt(1);){const t=(a+n)/BigInt(2);let e=!1,o=BigInt(0);for(let n=0;n<i.length;++n)if((o+=i[n]/t)>=r){a=t,e=!0;break}e||(n=t)}return a}function findSeatPriceForProtocolAfter49(t,e,i){if(2!=i.length)throw Error("minimumStakeRatio should have 2 elements");const r=t.map(t=>BigInt(t.stake)).sort(utils_1.sortBigIntAsc),o=r.reduce((t,e)=>t+e);return t.length<e?o*BigInt(i[0])/BigInt(i[1]):r[0]+BigInt(1)}function diffEpochValidators(t,e){const i=new Map;t.forEach(t=>i.set(t.account_id,t));const r=new Set(e.map(t=>t.account_id));return{newValidators:e.filter(t=>!i.has(t.account_id)),removedValidators:t.filter(t=>!r.has(t.account_id)),changedValidators:e.filter(t=>i.has(t.account_id)&&i.get(t.account_id).stake!=t.stake).map(t=>({current:i.get(t.account_id),next:t}))}}exports.findSeatPrice=findSeatPrice,exports.diffEpochValidators=diffEpochValidators;

},{"./utils":353,"depd":89}],355:[function(require,module,exports){
...
},{"./near":356,"./wallet_account":357}],356:[function(require,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(t,n,e,o){return new(e||(e=Promise))(function(c,r){function i(t){try{s(o.next(t))}catch(t){r(t)}}function a(t){try{s(o.throw(t))}catch(t){r(t)}}function s(t){var n;t.done?c(t.value):(n=t.value,n instanceof e?n:new e(function(t){t(n)})).then(i,a)}s((o=o.apply(t,n||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.Near=void 0;const accounts_1=require("@near-js/accounts");class Near{constructor(t){var n;if(this.config=t,this.connection=accounts_1.Connection.fromConfig({networkId:t.networkId,provider:t.provider||{type:"JsonRpcProvider",args:{url:t.nodeUrl,headers:t.headers}},signer:t.signer||{type:"InMemorySigner",keyStore:t.keyStore||(null===(n=t.deps)||void 0===n?void 0:n.keyStore)},jsvmAccountId:t.jsvmAccountId||`jsvm.${t.networkId}`}),t.masterAccount){const n=t.initialBalance?BigInt(t.initialBalance):BigInt("500000000000000000000000000");this.accountCreator=new accounts_1.LocalAccountCreator(new accounts_1.Account(this.connection,t.masterAccount),n)}else t.helperUrl?this.accountCreator=new accounts_1.UrlAccountCreator(this.connection,t.helperUrl):this.accountCreator=null}account(t){return __awaiter(this,void 0,void 0,function*(){return new accounts_1.Account(this.connection,t)})}createAccount(t,n){return __awaiter(this,void 0,void 0,function*(){if(!this.accountCreator)throw new Error("Must specify account creator, either via masterAccount or helperUrl configuration settings.");return yield this.accountCreator.createAccount(t,n),new accounts_1.Account(this.connection,t)})}}exports.Near=Near;

},{"@near-js/accounts":265}],357:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";var __awaiter=this&&this.__awaiter||function(e,t,n,i){return new(n||(n=Promise))(function(s,a){function o(e){try{c(i.next(e))}catch(e){a(e)}}function r(e){try{c(i.throw(e))}catch(e){a(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof n?t:new n(function(e){e(t)})).then(o,r)}c((i=i.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.ConnectedWalletAccount=exports.WalletConnection=void 0;const accounts_1=require("@near-js/accounts"),crypto_1=require("@near-js/crypto"),utils_1=require("@near-js/utils"),transactions_1=require("@near-js/transactions"),borsh_1=require("borsh"),LOGIN_WALLET_URL_SUFFIX="/login/",MULTISIG_HAS_METHOD="add_request_and_confirm",LOCAL_STORAGE_KEY_SUFFIX="_wallet_auth_key",PENDING_ACCESS_KEY_PREFIX="pending_key";class WalletConnection{constructor(e,t){if("string"!=typeof t)throw new Error("Please define a clear appKeyPrefix for this WalletConnection instance as the second argument to the constructor");if("undefined"==typeof window)return new Proxy(this,{get:(e,t)=>"isSignedIn"===t?()=>!1:"getAccountId"===t?()=>"":e[t]&&"function"==typeof e[t]?()=>{throw new Error("No window found in context, please ensure you are using WalletConnection on the browser")}:e[t]});this._near=e;const n=t+LOCAL_STORAGE_KEY_SUFFIX,i=JSON.parse(window.localStorage.getItem(n));this._networkId=e.config.networkId,this._walletBaseUrl=e.config.walletUrl,t=t||e.config.contractName||"default",this._keyStore=e.connection.signer.keyStore,this._authData=i||{allKeys:[]},this._authDataKey=n,this.isSignedIn()||(this._completeSignInPromise=this._completeSignInWithAccessKey())}isSignedIn(){return!!this._authData.accountId}isSignedInAsync(){return __awaiter(this,void 0,void 0,function*(){return this._completeSignInPromise?(yield this._completeSignInPromise,this.isSignedIn()):this.isSignedIn()})}getAccountId(){return this._authData.accountId||""}requestSignInUrl({contractId:e,methodNames:t,successUrl:n,failureUrl:i}){return __awaiter(this,void 0,void 0,function*(){const s=new URL(window.location.href),a=new URL(this._walletBaseUrl+LOGIN_WALLET_URL_SUFFIX);if(a.searchParams.set("success_url",n||s.href),a.searchParams.set("failure_url",i||s.href),e){const t=yield this._near.account(e);yield t.state(),a.searchParams.set("contract_id",e);const n=crypto_1.KeyPair.fromRandom("ed25519");a.searchParams.set("public_key",n.getPublicKey().toString()),yield this._keyStore.setKey(this._networkId,PENDING_ACCESS_KEY_PREFIX+n.getPublicKey(),n)}return t&&t.forEach(e=>{a.searchParams.append("methodNames",e)}),a.toString()})}requestSignIn(e){return __awaiter(this,void 0,void 0,function*(){const t=yield this.requestSignInUrl(e);window.location.assign(t)})}requestSignTransactionsUrl({transactions:e,meta:t,callbackUrl:n}){const i=new URL(window.location.href),s=new URL("sign",this._walletBaseUrl);return s.searchParams.set("transactions",e.map(e=>(0,borsh_1.serialize)(transactions_1.SCHEMA.Transaction,e)).map(e=>Buffer.from(e).toString("base64")).join(",")),s.searchParams.set("callbackUrl",n||i.href),t&&s.searchParams.set("meta",t),s.toString()}requestSignTransactions(e){const t=this.requestSignTransactionsUrl(e);window.location.assign(t)}_completeSignInWithAccessKey(){return __awaiter(this,void 0,void 0,function*(){const e=new URL(window.location.href),t=e.searchParams.get("public_key")||"",n=(e.searchParams.get("all_keys")||"").split(","),i=e.searchParams.get("account_id")||"";if(i){const e={accountId:i,allKeys:n};window.localStorage.setItem(this._authDataKey,JSON.stringify(e)),t&&(yield this._moveKeyFromTempToPermanent(i,t)),this._authData=e}e.searchParams.delete("public_key"),e.searchParams.delete("all_keys"),e.searchParams.delete("account_id"),e.searchParams.delete("meta"),e.searchParams.delete("transactionHashes"),window.history.replaceState({},document.title,e.toString())})}_moveKeyFromTempToPermanent(e,t){return __awaiter(this,void 0,void 0,function*(){const n=yield this._keyStore.getKey(this._networkId,PENDING_ACCESS_KEY_PREFIX+t);yield this._keyStore.setKey(this._networkId,e,n),yield this._keyStore.removeKey(this._networkId,PENDING_ACCESS_KEY_PREFIX+t)})}signOut(){this._authData={},window.localStorage.removeItem(this._authDataKey)}account(){return this._connectedAccount||(this._connectedAccount=new ConnectedWalletAccount(this,this._near.connection,this._authData.accountId)),this._connectedAccount}}exports.WalletConnection=WalletConnection;class ConnectedWalletAccount extends accounts_1.Account{constructor(e,t,n){super(t,n),this.walletConnection=e}signAndSendTransaction({receiverId:e,actions:t,walletMeta:n,walletCallbackUrl:i=window.location.href}){const s=Object.create(null,{signAndSendTransaction:{get:()=>super.signAndSendTransaction}});return __awaiter(this,void 0,void 0,function*(){const a=yield this.connection.signer.getPublicKey(this.accountId,this.connection.networkId);let o=yield this.accessKeyForTransaction(e,t,a);if(!o)throw new Error(`Cannot find matching key for transaction sent to ${e}`);if(a&&a.toString()===o.public_key)try{return yield s.signAndSendTransaction.call(this,{receiverId:e,actions:t})}catch(n){if("NotEnoughAllowance"!==n.type)throw n;o=yield this.accessKeyForTransaction(e,t)}const r=yield this.connection.provider.block({finality:"final"}),c=(0,utils_1.baseDecode)(r.header.hash),l=crypto_1.PublicKey.from(o.public_key),u=o.access_key.nonce+BigInt(1),h=(0,transactions_1.createTransaction)(this.accountId,l,e,u,t,c);return yield this.walletConnection.requestSignTransactions({transactions:[h],meta:n,callbackUrl:i}),new Promise((e,t)=>{setTimeout(()=>{t(new Error("Failed to redirect to sign transaction"))},1e3)})})}accessKeyMatchesTransaction(e,t,n){return __awaiter(this,void 0,void 0,function*(){const{access_key:{permission:i}}=e;if("FullAccess"===i)return!0;if(i.FunctionCall){const{receiver_id:e,method_names:s}=i.FunctionCall;if(e===this.accountId&&s.includes(MULTISIG_HAS_METHOD))return!0;if(e===t){if(1!==n.length)return!1;const[{functionCall:e}]=n;return e&&(!e.deposit||"0"===e.deposit.toString())&&(0===s.length||s.includes(e.methodName))}}return!1})}accessKeyForTransaction(e,t,n){return __awaiter(this,void 0,void 0,function*(){const i=yield this.getAccessKeys();if(n){const s=i.find(e=>e.public_key.toString()===n.toString());if(s&&(yield this.accessKeyMatchesTransaction(s,e,t)))return s}const s=this.walletConnection._authData.allKeys;for(const n of i)if(-1!==s.indexOf(n.public_key)&&(yield this.accessKeyMatchesTransaction(n,e,t)))return n;return null})}}exports.ConnectedWalletAccount=ConnectedWalletAccount;

}).call(this)}).call(this,require("buffer").Buffer)
},{"@near-js/accounts":265,"@near-js/crypto":272,"@near-js/transactions":329,"@near-js/utils":347,"borsh":39,"buffer":75}]},{},[283]);
